...
> Ссылка для скачиваения apk приложения до решения проблемы: [Приложение с проблемой][appWithProblem]
...
> Вы можете скачать приложение с применённым решением: [Исправленное приложение][appWithOutProblem]
